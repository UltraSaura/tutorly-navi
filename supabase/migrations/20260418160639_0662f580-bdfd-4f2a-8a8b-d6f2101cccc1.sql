...
BEGIN
  ...
  IF to_regclass('public.objectives') IS NOT NULL
     AND to_regclass('public.subjects') IS NOT NULL THEN
  ...
  IF to_regclass('public.objectives') IS NOT NULL
     AND to_regclass('public.subdomains') IS NOT NULL THEN
    UPDATE public.objectives o
  ...
  IF to_regclass('public.success_criteria') IS NOT NULL
     AND to_regclass('public.objectives') IS NOT NULL THEN
  ...
  IF to_regclass('public.tasks') IS NOT NULL
     AND to_regclass('public.success_criteria') IS NOT NULL THEN
  ...
  IF to_regclass('public.topic_objective_links') IS NOT NULL
     AND to_regclass('public.objectives') IS NOT NULL THEN
  ...
  IF to_regclass('public.lessons') IS NOT NULL
     AND to_regclass('public.topic_objective_links') IS NOT NULL THEN
  ...
  IF to_regclass('public.objective_mastery') IS NOT NULL
     AND to_regclass('public.objectives') IS NOT NULL THEN
  ...
  IF to_regclass('public.tasks') IS NOT NULL
     AND to_regclass('public.success_criteria') IS NOT NULL
     AND to_regclass('public.subjects') IS NOT NULL
     AND to_regclass('public.domains') IS NOT NULL
     AND to_regclass('public.subdomains') IS NOT NULL THEN
