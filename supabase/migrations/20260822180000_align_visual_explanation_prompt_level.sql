-- Update explanation and grouped retry prompt templates to align visual arithmetic explanations with student level (CM1/CM2 column layout / place-value decomposition instead of drawing dots).
