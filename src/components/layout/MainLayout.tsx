...
const MainLayout = () => {
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-blue-50 to-white dark:from-gray-950 dark:to-gray-900 relative overflow-hidden">
      ...
      <main className="flex-1 w-full">
        <div className="animate-fade-in studywhiz-container py-4 md:py-8">
          <Outlet />
        </div>
      </main>
